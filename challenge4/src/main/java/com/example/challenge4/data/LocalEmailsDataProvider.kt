...
object LocalEmailsDataProvider {
    ...
    private val threads = listOf(
        ...
        Email(
            ...
            attachments = listOf(
                EmailAttachment(R.drawable.paris_3, "Bridge in Paris"),
                EmailAttachment(R.drawable.paris_4, "Bridge in Paris at night"),
    ...
    val allEmails = listOf(
        ...
        Email(
            ...
            listOf(
                EmailAttachment(R.drawable.paris_4, "Bridge in Paris"),
                EmailAttachment(R.drawable.paris_3, "Bridge in Paris at night"),
                EmailAttachment(R.drawable.paris_3, "City street in Paris"),
                EmailAttachment(R.drawable.paris_4, "Street with bike in Paris")
            ),
            createdAt = "1 hour ago",
